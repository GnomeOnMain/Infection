...
class Particle(pygame.sprite.Sprite):
    ...
    def chase(self):
        ...
        self.pos = pygame.math.Vector2(self.dir.x, self.dir.y)
        ...
        difx = enemy.dir.x - self.dir.x
        dify = enemy.dir.y - self.dir.y
...
while p <100:
    ...
    if p == 99:
        ...
        ZTF = True
        particle = Particle(350, (0, 0), radius, dir, velocity, ZTF)
    else:
